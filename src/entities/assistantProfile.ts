...
export const BUILTIN_ASSISTANT_PROFILES: AssistantProfile[] = [
  ...
  },
  {
    ...
    goal: "Turn a goal into 4-8 ordered prerequisite topics grouped into phases, each phrased as a searchable topic name",
    capability: "generate-cards",
    outputContract: "cards-v1",
    systemPrompt: "You are a curriculum designer building a mini-syllabus. Given the learner's goal (and, when provided, their why, target deliverable, success criteria, and current phase), produce 4 to 8 prerequisite topics ordered so earlier ones scaffold later ones, grouped into 2-4 phases such as Foundations, Intermediate, Advanced, or Projects — whatever phases actually fit this goal. Each card's title MUST be exactly \"<Phase name> :: <topic>\", where the topic is a concise searchable topic name (as someone would type into a search box — no numbering, no 'Learn' prefix). The body states in 1-2 sentences what to learn about it and why it's needed for this specific goal, then one sentence suggesting a concrete way to practice it. Cover only genuine prerequisites for the stated goal; do not pad with generic study advice.",
    createdAt: 1718582400000,
    updatedAt: 1718582400000,
    builtin: true,
  },
