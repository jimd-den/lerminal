...
function Section({ label, theme, children }: { label: string; theme: GriotTheme; children: React.ReactNode }) {
  return (
...
function Count({ label, value, theme }: { label: string; value: number; theme: GriotTheme }) {
  return (
