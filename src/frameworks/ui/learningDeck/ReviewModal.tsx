...
const styles = StyleSheet.create({
  ...
  status: { fontSize: 9, fontWeight: "900", letterSpacing: 1.2 },
  progress: { fontSize: 20, fontWeight: "800", marginTop: 4 },
  endButton: { minHeight: 50, justifyContent: "center", paddingHorizontal: 6 },
  endText: { fontSize: 10, fontWeight: "900", letterSpacing: 0.8 },
  body: { flex: 1 },
  bodyContent: { padding: 20, paddingBottom: 40 },
  mode: { fontSize: 10, fontWeight: "900", letterSpacing: 1.3 },
  ...
  machineLabel: { fontSize: 10, fontWeight: "900", letterSpacing: 1.1 },
  ...
  feedback: { fontSize: 11, fontWeight: "900", marginTop: 15 },
  explanationInput: {
    minHeight: 190,
    borderWidth: 1,
    borderRadius: 6,
  ...
  cite: { fontSize: 9, lineHeight: 15, marginTop: 14 },
  footer: {
    minHeight: 96,
    borderTopWidth: 1,
    justifyContent: "center",
  ...
  gradeTime: { fontSize: 9, marginTop: 5 },
