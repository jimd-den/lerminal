...
function EmptyPanel({ theme, text }: { theme: LearningTheme; text: string }) {
  return (
...
function buildInteractiveHtml(body: string, theme: LearningTheme): string {
...
function markdownStyles(theme: LearningTheme): any {
  return {
