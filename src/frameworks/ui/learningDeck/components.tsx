...
export function TextButton({ label, onPress, theme }: { label: string; onPress: () => void; theme: LearningTheme }) {
  return (
...
export function SectionLabel({ children, theme, code }: { children: React.ReactNode; theme: LearningTheme; code?: string }) {
  return (
...
export function Chip({ label, active, theme, onPress }: { label: string; active: boolean; theme: LearningTheme; onPress: () => void }) {
  return (
    <Pressable
      accessibilityRole="button"
...
export function BottomNavigation({ place, theme, onChange }: { place: CorePlace; theme: LearningTheme; onChange: (place: CorePlace) => void }) {
...
const styles = StyleSheet.create({
  ...
  systemId: { fontSize: 9, fontWeight: "800", letterSpacing: 1.2 },
  readyText: { fontSize: 9, fontWeight: "900", letterSpacing: 1.4 },
  eyebrow: { fontSize: 10, lineHeight: 15, fontWeight: "900", letterSpacing: 1.6, marginTop: 2 },
  ...
  sectionCode: { fontSize: 10, letterSpacing: 1 },
  ...
  slabLabel: { fontSize: 10, lineHeight: 14, fontWeight: "800", letterSpacing: 1.3, marginBottom: 3 },
  ...
  chipText: { fontSize: 11, fontWeight: "800", letterSpacing: 0.7 },
  ...
  navLabel: { fontSize: 11, lineHeight: 15, fontWeight: "600" },
